  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Configure your AI receptionist integrations and business settings</p>
      </div>
            ...
            <div key={config.id} className="card p-6">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-4">
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center text-lg ${config.color}`}>
                    {config.icon}
                  </div>
                  <div>
              ...
              <div className="space-y-4">
                ...
                {config.id === 'vapi' && (
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-medium text-blue-900 mb-2">Vapi Integration</h4>
                ...
                {config.id === 'n8n' && (
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <h4 className="font-medium text-purple-900 mb-2">n8n Workflow</h4>
        ...
        <div className="space-y-6">
          ...
          <div className="card p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-gray-900">AI Voice Agent Configuration</h2>
              <div className="flex items-center space-x-3">
                <button
            ...
            {showPrompt && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-gray-900">Generated Voice Agent Prompt</h3>
                  <button
      ...
      {activeTab === 'business' && (
        <div className="space-y-6">
          <div className="card p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Business Configuration</h2>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              <h4 className="font-medium text-blue-900 mb-2">Business Configuration Preview</h4>
