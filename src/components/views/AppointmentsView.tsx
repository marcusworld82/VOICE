    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600">Manage your appointment calendar and bookings</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="metric-card">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-1">{todayAppointments.length}</h3>
                ...
                todayAppointments.map((appointment) => (
                  <div key={appointment.id} className="p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <h4 className="font-medium text-gray-900">{appointment.client.name}</h4>
                        <p className="text-sm text-gray-600">{formatTime(appointment.datetime)}</p>
                      </div>
                      <span className={`status-badge ${getStatusColor(appointment.status)}`}>
                        {appointment.status}
                      </span>
                    </div>
                    <p className="text-sm text-gray-700 mb-2">{appointment.service}</p>
                    {appointment.notes && (
