    ...
    <div className="p-3 sm:p-4 lg:p-6 xl:p-8 max-w-full overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 sm:mb-6 lg:mb-8">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600">Manage your client relationships and CRM data</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6 lg:mb-8">
        <div className="metric-card">
          ...
          <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-1">{clients.filter(c => c.status === 'active').length}</h3>
        ...
        <div className="metric-card">
          ...
          <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-1">{clients.filter(c => c.status === 'prospect').length}</h3>
          <p className="text-xs sm:text-sm text-gray-600">Prospects</p>
        </div>
        ...
        <div className="metric-card">
          ...
          <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-1">{clients.length}</h3>
      ...
      <div className="card p-3 sm:p-4 lg:p-6 mb-4 sm:mb-6 lg:mb-8">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
          ...
          <button className="btn-secondary flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm px-2 sm:px-3 py-1.5 sm:py-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
        <div className="lg:col-span-2">
          <div className="space-y-4">
            {filteredClients.map((client) => (
              <div
                key={client.id}
                className="card-hover p-3 sm:p-4 lg:p-6 cursor-pointer"
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                      ...
                      <div>
                        <h3 className="text-sm sm:text-base font-semibold text-gray-900">{client.name}</h3>
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-4 text-xs sm:text-sm">
                      <div>
                        ...
                        <div className="font-medium text-gray-900 text-sm sm:text-base">{client.totalAppointments}</div>
                      </div>
                      <div>
                        <span className="text-gray-500">Total Spent:</span>
                        <div className="font-medium text-green-600 text-sm sm:text-base">${client.totalSpent.toLocaleString()}</div>
                      </div>
                      <div>
                        <span className="text-gray-500">Last Contact:</span>
                        <div className="font-medium text-gray-900 text-sm sm:text-base">{new Date(client.lastContact).toLocaleDateString()}</div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="lg:col-span-1">
          {selectedClient ? (
            <div className="card p-3 sm:p-4 lg:p-6 sticky top-8">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900">{selectedClient.name}</h3>
              ...
              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                ...
                <div>
                  <label className="text-xs sm:text-sm font-medium text-gray-500">Client Metrics</label>
                  <div className="mt-1 sm:mt-2 grid grid-cols-2 gap-2 sm:gap-4">
                    <div className="text-center p-2 sm:p-3 bg-gray-50 rounded-lg">
                      <div className="text-base sm:text-lg font-bold text-gray-900">{selectedClient.totalAppointments}</div>
                      <div className="text-xs text-gray-500">Appointments</div>
                    </div>
                    <div className="text-center p-2 sm:p-3 bg-gray-50 rounded-lg">
                      <div className="text-base sm:text-lg font-bold text-green-600">${selectedClient.totalSpent}</div>
                ...
                <div>
                  ...
                  <div className="mt-1 sm:mt-2 p-2 sm:p-3 bg-gray-50 rounded-lg">
                    <p className="text-xs sm:text-sm text-gray-700">{selectedClient.notes}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <button 
                  ...
                  className="btn-secondary w-full text-xs sm:text-sm py-2 sm:py-3"
                >
                  Send Message
                </button>
              </div>
            ...
            <div className="card p-3 sm:p-4 lg:p-6 text-center">
              <Users className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 text-gray-400 mx-auto mb-2 sm:mb-4" />
              <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-1 sm:mb-2">Select a Client</h3>
              <p className="text-xs sm:text-sm lg:text-base text-gray-600">Click on a client to view their detailed information and history.</p>
            </div>
          )}
        </div>
      </div>
